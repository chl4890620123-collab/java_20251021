...
public class sample {
	...
	float f2 = 2147483648L;
	float f3 = 2147483558L;
	float f4 = 2147483668L;
     ...
     *  
     *  변수명, 클래스명 -> 영문자 대소문자, 숫자, 특수문자( _ , $) 조합해서 만들수있음
     *  단, 숫자는 맨 앞에 기입할 수 없다, 예약어는 사용할 수 없다. 패키지에 있는거 불가
     *  age(0)
     *  _age1(0)
     *  $age1(0)
     *  1age(x)
